...
document.querySelectorAll('.detalle-reactivo').forEach(element => {
    element.addEventListener('click', function () {
        ...
        const reactivo = obtenerInformacionReactivo(reactivoId, reactivoName, reactivoDate, reactivoOrder, reactivoTrademark, reactivoReference, reactivoQuantity, reactivoUnit, reactivoDateOrder, reactivoLab,reactivoDateCreate,reactivoNProject,reactivoPrice,reactivoDestination,reactivoManager,reactivoLocation,reactivoSchool,reactivoObservations,reactivoCreateBy,reactivoLastUpdate,reactivoLastUpdateBy);
...
function obtenerInformacionReactivo(reactivo, name, date, order, trademark, reference, quantity, unit, date_order,lab,date_create,nproject,price,destination,manager,location,school,observations,create_by,last_update,update_by) {
