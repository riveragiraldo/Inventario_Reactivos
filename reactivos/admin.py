...
class Unidadesadmin(admin.ModelAdmin):
    list_display=('id','name','fecha_registro', 'user','ultima_actualizacion','last_updated_by',)
    ordering=('id',)
...
class Ubicacionadmin(admin.ModelAdmin):
    list_display=('id','name','facultad','fecha_registro', 'user','ultima_actualizacion','last_updated_by',)
    ordering=('id',)
...
class Respeladmin(admin.ModelAdmin):
    list_display=('id','name','description','fecha_registro', 'user','ultima_actualizacion','last_updated_by',)
    ordering=('id',)
...
class Responsableadmin(admin.ModelAdmin):
    list_display=('id','name','mail','phone','is_active','cc','fecha_registro', 'user','ultima_actualizacion','last_updated_by',)
    ordering=('id',)
...
class Almacenamientoadmin(admin.ModelAdmin):
    list_display=('id','lab','name','description','fecha_registro', 'user','ultima_actualizacion','last_updated_by',)
    ordering=('id',)
...
class Reactivosadmin(admin.ModelAdmin):
    list_display=('id','code','cas','name','state','unit','respel','sga','fecha_registro','fecha_registro', 'user','ultima_actualizacion','last_updated_by',)
...
class Entradaadmin(admin.ModelAdmin):
    list_display=('id','date','name','trademark','reference','weight','order','manager','observations','location','price','nproject','destination','lab','observations', 'user','ultima_actualizacion','last_updated_by',)
...
class Salidaadmin(admin.ModelAdmin):
    list_display=('id','date','name','trademark','reference','weight','destination','manager','observations','location','lab', 'user','ultima_actualizacion','last_updated_by',)
    list_filter=('date','name','lab')
    search_fields=('date','name','lab')
    list_per_page=10
    ordering=('id',)
...
class Inventarioadmin(admin.ModelAdmin):
    list_display=('id','name','trademark','weight','reference','lab','fecha_registro','wlocation','minstock','edate','is_active', 'user','ultima_actualizacion','last_updated_by',)
