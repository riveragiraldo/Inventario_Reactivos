...
urlpatterns = [
    ...
    path('reactivos/registrar_salida_confirm/',
         registrar_salida_confirm, name='registrar_salida_confirm'),
    path('reactivos/registrar_entrada/',
         registrar_entrada, name='registrar_entrada'),
    path('reactivos/registrar_entrada_confirm/',
         registrar_entrada_confirm, name='registrar_entrada_confirm'),
    path('reactivos/inventario/', InventarioListView.as_view(), name='inventario'),
    path('get-value/', get_value, name='get_value'),
    path('autocomplete/', autocomplete, name='autocomplete'),
    path('autocomplete_out/', autocomplete_out, name='autocomplete_out'),
    ...
    path('guardar-per-page/<int:per_page>/',
         GuardarPerPageView.as_view(), name='GuardarPerPage')
