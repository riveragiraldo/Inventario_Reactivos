...
urlpatterns = [
    ...
    path('administrar/listado_eventos/', EventosListView.as_view(), name='listado_eventos'),
    ...
    path('export2xlsxevent/', views.export_to_excel_event, name='export_to_excel_event'),
    ...
    path('guardar-per-page-event/<int:per_page>/', GuardarPerPageViewEvent.as_view(), name='GuardarPerPageEvent'),
