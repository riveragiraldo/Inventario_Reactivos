...
urlpatterns = [
    ...
    path('api/trademarksandreferences/', TrademarksandReferencesAPI.as_view(), name='select-trademarksandreferences'),
    ...
    #path('api/trademarksbyreference/', TrademarksByReferenceAPI.as_view(), name='select-updatetrademarks'),
    path('api/trademarksandnamesbyreference/', TrademarksAndNamesByReferenceAPI.as_view(), name='select-updatetrademarksandreferences'),
