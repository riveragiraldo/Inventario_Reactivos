    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('minstock', models.DecimalField(blank=True, decimal_places=2, default=0, help_text='Ingrese el stock mínimo (puede ser nulo).', max_digits=7, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lab', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lab_name', to='reactivos.laboratorios', verbose_name='laboratory')),
